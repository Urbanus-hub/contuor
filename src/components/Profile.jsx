      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid grid-cols-1 xl:grid-cols-4 gap-8'>
          ...
          <div className='xl:col-span-1 space-y-6'>
            {/* Profile Card */}
            <div className='bg-white rounded-3xl s p-8 border border-gray-100 relative overflow-hidden'>
              
              <div className='text-center relative'>
                <div className='w-28 h-28 bg-gradient-to-br from-[#3B5D50] to-[#4A6B5E] rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl ring-4 ring-white'>
          ...
          <div className='xl:col-span-3 space-y-8'>
            ...
            <div className='bg-white rounded-3xl  p-8 border border-gray-100 relative overflow-hidden'>
